...
LINK=$(LINKER)
LOBJ=$(LD)/icharset.o $(LD)/chars.o $(LD)/socket.o $(LD)/log.o $(LD)/storage.o $(LD)/string.o $(LD)/mutexsync.o $(LD)/tools.o $(LD)/thread.o   $(LD)/time.o $(LD)/dir.o $(LD)/limit.o $(LD)/eventpoller.o $(LD)/dfile.o
...
OBJS=maymemcached.o WebThreadManager.o WebThread.o threadman.o $(LOBJ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
